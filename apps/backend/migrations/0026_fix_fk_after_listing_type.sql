-- Migration 0026: Fix broken FK references in favorites and reports after 0024
-- Migration 0024 renamed listings→listings_old then dropped it; SQLite updated
-- FK references to listings_old which no longer exists.
